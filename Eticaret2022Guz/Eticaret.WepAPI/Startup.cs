...
namespace Eticaret.WepAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IBrandDal, EfBrandRepository>();
            services.AddTransient<ISubCategoryService, SubCategoryService>();
            services.AddTransient<ISubCategoryDal, EfSubCategoryRepository>();
            services.AddTransient<ISubCategoryBrandService, SubCategoryBrandService>();
            services.AddTransient<ISubCategoryBrandDal, EfSubCategoryBrandRepository>();
        }
